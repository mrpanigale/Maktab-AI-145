"""
This file trains a simple CNN model on Fashion data and saves the model along with its reports.
"""
...
csv_report.to_csv(report_path/"FashionCNN.csv",index=False)
